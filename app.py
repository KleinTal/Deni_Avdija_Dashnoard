...
def get_player_career_stats(player_name):
    ...
    columns_to_keep_basic = [
        'GROUP_SET', 'GROUP_VALUE', 'MAX_GAME_DATE', 'GP', 'W', 'L', 'W_PCT',
    ...
    columns_to_keep_adv = [
        ...
        'NET_RATING', 'AST_PCT', 'AST_TO', 'AST_RATIO', 'EFG_PCT', 'TS_PCT', 'USG_PCT', 'PACE',
        'PIE', 'POSS', 'FGM_PG', 'FGA_PG'
    ]
...
if player_id is None:
    ...
    # # Save to a CSV file
    # DA_shooting_stats.to_csv('deni_avdija_shooting_stats_all_seasons.csv', index=False)
    # print(DA_shooting_stats.columns)
    # print(DA_shooting_stats['SHOT_ZONE_RANGE'].unique())
